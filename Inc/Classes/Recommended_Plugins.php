	...
	class Recommended_Plugins extends Recommended {
		...
		public function admin_menu() {
			...
			$this->sub_menu = add_submenu_page(
				'options-general.php',       // Ex. image-source-by-id-settings /  edit.php?post_type=page .
				__( 'Recommended', 'image-source-by-id' ),
				__( 'Recommended', 'image-source-by-id' ),
				'manage_options',
				'image-source-by-id-recommended-plugins',
