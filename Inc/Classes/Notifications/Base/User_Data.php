<?php
namespace JLTISRC\Inc\Classes\Notifications\Base;
...
trait User_Data {
	...
	public function is_local_server() {
		...
		return apply_filters( 'jlt_image_source_id_is_local', $is_local );
	}
	...
	public function get_collect_data( $user_id, $arr = [] ){
		...
		$data = array(
			...
			'is_active_product'		  => 1,
			'installed_product_slug'  => JLTISRC_SLUG,
		);

		$payload_data =  array_merge( $arr, $data );
		$endpoint_url = \JLTISRC\Libs\Helper::crm_endpoint();
